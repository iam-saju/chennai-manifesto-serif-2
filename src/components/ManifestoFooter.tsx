      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-4 md:gap-8 items-end">
          ...
          <div className="flex flex-col justify-between h-full space-y-4 md:space-y-6 text-center md:text-left">
            ...
            {/* Separator line */}
            <div className={`border-t my-2 md:my-4 transition-colors duration-500 ${
              isSolarized ? 'border-orange-400' : 'border-gray-600'
            }`}></div>
            
            {/* Waiting List Form */}
            <div className="space-y-2 md:space-y-6">
              <h3 className={`font-serif text-base md:text-lg font-medium transition-colors duration-500 ${
                ...
                >
                  ...
                  <Button 
                    ...
                    className={`font-medium px-6 transition-all duration-300 ${
                      isSolarized
                        ? 'bg-orange-500 text-white border border-orange-600 hover:bg-orange-600 hover:border-orange-700 shadow-lg shadow-orange-500/20'
                        : 'bg-card border border-border text-foreground hover:bg-muted hover:text-foreground'
                    }`}
                  >
                    Notify Me
                  </Button>
            ...
            <div className={`pt-6 border-t transition-colors duration-500 ${
              ...
              <p className={`text-sm tracking-wider !whitespace-pre-line flex items-center gap-2 transition-colors duration-500 ${
                isSolarized ? 'text-red-600' : 'text-gray-500'
              }`}>
                <span className={`w-2 h-2 rounded-full animate-pulse shadow-lg transition-colors duration-500 ${
